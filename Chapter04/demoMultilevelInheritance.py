...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(30, 30, 111, 18))
        self.label.setObjectName("label")
        self.lineEditCode = QtWidgets.QLineEdit(Dialog)
        self.lineEditCode.setGeometry(QtCore.QRect(160, 20, 201, 32))
        self.lineEditCode.setObjectName("lineEditCode")
        self.ButtonClickMe = QtWidgets.QPushButton(Dialog)
        self.ButtonClickMe.setGeometry(QtCore.QRect(150, 330, 91, 34))
        self.ButtonClickMe.setObjectName("ButtonClickMe")
        self.lineEditName = QtWidgets.QLineEdit(Dialog)
        self.lineEditName.setGeometry(QtCore.QRect(160, 70, 201, 32))
        self.lineEditName.setObjectName("lineEditName")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(30, 80, 111, 18))
        self.label_2.setObjectName("label_2")
        self.lineEditGeographyMarks = QtWidgets.QLineEdit(Dialog)
        self.lineEditGeographyMarks.setGeometry(QtCore.QRect(160, 170, 201, 32))
        ...
        self.label_4.setGeometry(QtCore.QRect(30, 180, 111, 18))
        self.label_4.setObjectName("label_4")
        self.lineEditHistoryMarks = QtWidgets.QLineEdit(Dialog)
        self.lineEditHistoryMarks.setGeometry(QtCore.QRect(160, 120, 201, 32))
        ...
        self.lineEditTotal.setGeometry(QtCore.QRect(160, 220, 201, 32))
        self.lineEditTotal.setObjectName("lineEditTotal")
        self.label_5 = QtWidgets.QLabel(Dialog)
        self.label_5.setGeometry(QtCore.QRect(30, 230, 111, 18))
        self.label_5.setObjectName("label_5")
        self.lineEditPercentage = QtWidgets.QLineEdit(Dialog)
        self.lineEditPercentage.setEnabled(False)
        self.lineEditPercentage.setGeometry(QtCore.QRect(160, 270, 201, 32))
        self.lineEditPercentage.setObjectName("lineEditPercentage")
        self.label_6 = QtWidgets.QLabel(Dialog)
        self.label_6.setGeometry(QtCore.QRect(30, 280, 111, 18))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "HistoryMarks"))
