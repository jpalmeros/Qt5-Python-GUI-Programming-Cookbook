...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(40, 30, 151, 18))
        self.label.setObjectName("label")
        self.labelFare = QtWidgets.QLabel(Dialog)
        self.labelFare.setGeometry(QtCore.QRect(40, 250, 311, 18))
        self.labelFare.setText("")
        self.labelFare.setObjectName("labelFare")
        self.radioButtonFirstClass = QtWidgets.QRadioButton(Dialog)
        self.radioButtonFirstClass.setGeometry(QtCore.QRect(50, 80, 131, 24))
        ...
        self.radioButtonBusinessClass.setGeometry(QtCore.QRect(50, 120, 161, 24))
        ...
        self.radioButtonEconomyClass.setGeometry(QtCore.QRect(50, 160, 161, 24))
