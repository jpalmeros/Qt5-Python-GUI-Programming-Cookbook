...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(461, 191)
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(30, 60, 171, 18))
        self.label.setObjectName("label")
        self.comboBoxAccountType = QtWidgets.QComboBox(Dialog)
        self.comboBoxAccountType.setGeometry(QtCore.QRect(200, 50, 221, 32))
        ...
        self.labelAccountType.setGeometry(QtCore.QRect(30, 120, 381, 18))
